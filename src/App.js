...
function StudentPanel({ user, onLogout }) {
  ...
  // Create a new attempt when student starts post-reading
  useEffect(() => {
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "28px 20px" }}>
        ...
        {stage === 2 && (
          <div>
            ...
            <p style={{ color: C.textMuted, fontSize: 14, marginBottom: 24 }}>Write your answers thoughtfully. Your teacher will review them.</p>
